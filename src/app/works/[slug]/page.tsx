            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-24">
                    {project.imageBefore && project.imageAfter ? (
                        ...
                        <div
                            className="w-full aspect-video bg-white/5 border border-white/5 flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                    ...
                    <div className="bg-white/[0.02] border border-white/10 p-5 h-fit backdrop-blur-sm">
                        <h2 className="text-[13px] font-mono text-blue-500 uppercase tracking-[0.2em] mb-4">System
                            Stack</h2>
                        <div className="flex flex-wrap gap-2">
                            {project.tags.map(tag => (
                                <span key={tag}
                                      className="px-2 py-1 bg-white/5 border border-white/10 text-white/60 text-[11px] font-mono uppercase tracking-wider">
                                    {tag}
                                </span>
                            ))}
                            <span
                                className="px-2 py-1 bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[11px] font-mono uppercase tracking-wider">TypeScript</span>
                        </div>
