...
export default function Hero() {
  ...
  return (
    <section
      ref={targetRef}
      className="min-h-svh [@media(max-height:750px)]:min-h-[750px] relative flex flex-col items-center justify-center w-full overflow-hidden border-b border-white pt-5 md:pt-8 lg:pt-12 pb-10"
    >
      <div className="relative z-10 max-w-5xl px-6 text-center">
        ...
        <motion.div
          ...
          animate={
            isReady ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.95 }
          }
          transition={{
            delay: isReady ? 1.6 : 0,
            duration: 0.6,
