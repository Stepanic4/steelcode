...
function LocationLink() {
  ...
  const castleImg =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Melnik.jpg/1280px-Melnik.jpg";
  ...
  return (
    ...
    >
      ...
      >
        <MapPin
          size={14}
          className={isHovered ? "text-blue-500" : "transition-colors"}
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, rgba(50, 255, 126, 0.1), rgba(100, 255, 100, 0.4), rgba(50, 255, 126, 0.1), transparent)",
                filter: "blur(3px)",
              }}
            />
            ...
            >
              ...
              <div className="space-y-4">
                <p className="text-lg leading-relaxed max-w-md">
                  Ready to discuss your project? We are based in the Czech
                  Republic and work with clients across Europe.
                </p>
