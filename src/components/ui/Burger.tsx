...
export default function Burger() {
    ...
    // Блокировка прокрутки body (Senior practice)
    useEffect(() => {
        if (isOpen) {
    ...
    const handleScroll = (id: string) => {
        ...
        if (element) {
            setIsOpen(false);
            // Задержка, чтобы анимация закрытия не конфликтовала со скроллом
            setTimeout(() => {
