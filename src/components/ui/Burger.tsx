...
const menuItems = [
  {
    ...
    code: "STUDIO_MANIFESTO",
  },
  {
    id: "works",
    label: "Portfolio",
    icon: <Briefcase size={24} />,
    code: "CASE_STUDIES_ARCHIVE",
  },

  {
    ...
    code: "DEVELOPMENT_MODELS",
  },
  {
    id: "contact",
    label: "Contact",
    icon: <Mail size={24} />,
    code: "DIRECT_ENQUIRY_LINE",
  },
];
...
export default function Burger() {
  ...
  const handleNavClick = (id: string) => {
    ...
    if (pathname === "/") {
      ...
      if (element) {
        // Задержка, чтобы анимация меню успела отработать
        setTimeout(() => {
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            >
              <div className="bg-zinc-900 border border-white/10 rounded-4xl overflow-hidden">
                ...
                <div className="px-7 py-5 bg-black/40 border-t border-white/5 flex flex-col gap-1">
                  ...
                  <div className="w-full h-1 bg-zinc-800/50 rounded-full mt-2 overflow-hidden relative">
                    <motion.div
                      initial={{ x: "-100%" }}
                      animate={{ x: "300%" }}
                      transition={{
                      ...
                      className="absolute top-0 left-0 w-1/3 h-full bg-linear-to-r from-transparent via-blue-500 to-transparent shadow-[0_0_10px_rgba(59,130,246,0.5)]"
                    />
                  </div>
                </div>
              </div>
